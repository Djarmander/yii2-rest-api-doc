...
## Installation
 - Run `composer require djarmander/yii2-rest-api-doc`;

Alternatively add into `require` section of your `composer.json` following string `"djarmander/yii2-rest-api-doc": "1.0"` and run `composer update`
 - In your application config file inside `modules` section add
```
'modules' => [
  ...
  'documentation' => 'djarmander\yii2\rest_api_doc\Module',
  ...
],
```
